        ...
        {projects.map((project, index) => (
          <div key={index} className="project-card block rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
            <div className="relative">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 bg-[#f3819c] bg-opacity-40 text-[#3e4355] p-2">
            ...
            <div className="p-4">
              <p className="text-gray-600 mb-4">
                ...
                {project.description.length > 150 ? <button className="text-blue-500" onClick={() => openPopUp(project)}>
              ...
              <div className="flex flex-wrap">
                {project.tags.map((tag, tagIndex) => (
                  <span key={tagIndex} className="bg-gray-300 text-[#3e4355] px-2 py-1 rounded-full text-sm mr-2 mb-2">
                    {tag}
                  </span>
                ))}
              </div>
